...
worksheet_whole.write('A8', 'CNV calls with log2 values inbetween ' + str(low_log) + ' and ' + str(high_log) +
...
worksheet_whole.write_row('A31', 'CNA bedfile: '+snakemake.input.gene_interest)
